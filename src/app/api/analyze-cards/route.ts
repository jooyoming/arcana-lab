...
[중요 예외 조항]
1. 사진에 가로로 겹쳐 있는 카드가 있다면 '켈틱 크로스' 배열일 확률이 높습니다! 가로로 덮인 카드와 그 아래 깔린 카드를 가장 주의 깊게 분석하세요.
2. 'The Inner Wheel' 배열은 중앙의 카드 1장을 중심으로 8장의 카드가 원형(수레바퀴 모양)으로 배치됩니다. 각 카드의 각도와 중심으로부터의 거리를 고려하여 포지션을 매핑하세요.
3. 'The Four Powers'는 상하좌우 대칭(다이아몬드 형태)의 기하학적 배치를 가집니다.
